...
{
	$archivo1= $_POST['archivos'];
}else{
	$archivo1= "";
}
		if($_plans->update_plan($fichero, $descripcion, $categoria, $cant_planificada, $cant_comprada, $valor_planificado, $valor_comprado, $comprador, $archivo1) == false);
		die('1');
		die('wrong');
	}
}
...
<body>
	<div id="main-wrapper">
		...
		<div class="wrapper-pad">
			...
			<!--Script separar lista compradores-->
			<?php
			...
			?>
						...
						<div class="ni-cont">
							<input type="text" id="fichero" name="fichero" class="ni" value="<?php echo $plan->archivo; ?>" />
