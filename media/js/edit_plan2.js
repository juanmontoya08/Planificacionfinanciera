...
$('document').ready(function() {
	...
	$('form[name=edit-plan]').submit(function(evt) {
		...
		$.post('edit_planificaciones2.php?id='+id, {
			'act':'1',
			'planid':id,
			...
			if(data == '1') {
				...
				alert('ESTA BIEN'+archivo);
			}else{
				alert('Algo salió mal. Por favor, inténtelo de nuevo21');
				console.log(id, descripcion, cat, cant_planificada, cant_comprada, valor_planificado, valor_comprado, comprador, archivo);
